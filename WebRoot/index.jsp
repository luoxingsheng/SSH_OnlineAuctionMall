			...
			<div class="adjust-nav">
				...
				<div>
					...
					<ul class="nav navbar-nav navbar-right col-md-2">
						<li><a href="login.jsp" class="glyphicon glyphicon-log-in"><span>登录</span></a>
						</li>
						<li><a href="user_register.action"
							class="glyphicon glyphicon-log-out"><span>注册</span></a></li>
					</ul>

					<form class="navbar-form navbar-right col-md-2" role="search"  action="goods_blurry" method="post">
